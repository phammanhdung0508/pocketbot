  ...
  async handle(
    ...
    try {
      ...
      if (availablePets.length === 0) {
        await message.reply(parseMarkdown("Hiện không có thú cưng nào khả dụng để chọn."));
        return;
      }
      ...
      let listMessage = "**Danh sách các thú cưng có thể chọn:**\n";
      ...
      await message.reply(parseMarkdown(`Lỗi khi liệt kê thú cưng: ${error.message}`));
    }
  }
}
