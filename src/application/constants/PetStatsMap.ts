...
const PET_STATS_MAP = {
  [PetSpecies.DRAGON]: {
    ...
    lv100: { hp: 1952, atk: 347, def: 268, spd: 249, energy: 12 },
  },
  [PetSpecies.FISH]: {
    lv1: { hp: 820, atk: 100, def: 110, spd: 120, energy: 8 },
    lv100: { hp: 1838, atk: 249, def: 308, spd: 338, energy: 16 },
  },
  [PetSpecies.GOLEM]: {
  ...
  [PetSpecies.BIRD]: {
    ...
    lv100: { hp: 1909, atk: 283, def: 194, spd: 437, energy: 14 },
  },
  [PetSpecies.EEL]: {
    lv1: { hp: 810, atk: 125, def: 85, spd: 130, energy: 8 },
    lv100: { hp: 1952, atk: 313, def: 244, spd: 357, energy: 16 },
  },
};
